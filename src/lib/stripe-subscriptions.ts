...
export const SUBSCRIPTION_TIERS: Record<SubscriptionTier, TierConfig> = {
  starter: {
    ...
    description: 'Essential whitelist form builder with up to 100 applicants per month and standard directory listing.',
    features: [
  ...
  pro: {
    ...
    description: 'Includes Sentinel AI Growth Studio, automated AI Lore Grader, Discord role sync, and priority Page 1–2 directory ranking.',
    highlight: true,
    features: [
  ...
  mega: {
    ...
    description: 'Full Sentinel Marketing Studio Suite with streamer outreach, unlimited player volume, Lua exports, glowing directory cards, and Pinned Top 5 Spotlight.',
    features: [
