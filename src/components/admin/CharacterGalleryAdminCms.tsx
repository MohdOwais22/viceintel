          ...
          <div className="bg-zinc-900 border border-rose-900/60 rounded-3xl max-w-md w-full p-6 space-y-4 shadow-2xl relative">
            ...
            <div>
              ...
              <p className="text-xs text-zinc-400 mt-1">
                Are you sure you want to remove <strong className="text-rose-300">"{deleteTarget.name}"</strong> from the gallery database? This action will remove the document from the database (MongoDB & Cloud Firestore).
              </p>
            </div>
